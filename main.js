...
let randFruit = Math.floor(Math.random() * count);    
  ...
  case 0:
    ...
    let queryA = window.matchMedia("(max-width: 600px)");
        if (queryA.matches) {
          groceries.style.paddingTop = "0px";
          groceries.style.paddingBottom = "0px";
   ...
   if (currentlyPlaying && isClicked(guessButton)) {
      ...
      if (query.matches) {
        ...
        groceries.style.marginTop = "91px";
        groceries.style.marginBottom = "16px";
    ...
    if (currentlyPlaying && isClicked(guessButton)) {
      ...
      if (query.matches) {
        ...
        guessButton.style.display = 'none';
        nextButton.style.display = 'inline';
        nextButton.style.marginBottom = "-50px";
        groceries.style.marginTop = "91px";
        groceries.style.marginBottom = "16px";
        question.style.color = 'lime';
        question.style.fontSize = "1.7rem";
...
//                               vegetables start here...
  ...
  nextButton.onclick = function() {
    ...
    if (query.matches) {
      ...
      groceries.style.marginTop = "97px";
      groceries.style.marginBottom = "17px";
